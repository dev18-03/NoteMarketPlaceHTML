...
namespace NoteMarketPlace.Models
{
    ...
    public partial class NotesMarketdbEntities : DbContext
    {
        public NotesMarketdbEntities()
            : base("name=NotesMarketdbEntities")
        {
        }
        ...
        public virtual DbSet<ManageSystemCofi> ManageSystemCofis { get; set; }
